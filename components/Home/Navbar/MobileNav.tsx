...
const MobileNav = ({ showNav, closeNav }: Props) => {
  ...
  return (
    <div>
      ...
      <div
        className={`text-white fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-[#1e1e5cec] space-y-6 z-100050 right-0 ${navOpen}`}
      >
        {NavURL.map((link) => {
          return (
